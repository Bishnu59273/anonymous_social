      ...
      <nav class="navbar navbar-expand-lg bg-light p-0">
        <div class="container-fluid">
          <NuxtLink class="navbar-brand" to="/"
            ><img src="/logo.png" alt="" class="logo m-0"
          /></NuxtLink>
          <div
            class="collapse navbar-collapse nav_content"
            id="navbarSupportedContent"
          >
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <NuxtLink class="nav-link active" to="/"
                  ><i class="bi bi-house"></i> Home</NuxtLink
                >
              </li>
              <li class="nav-item">
                <NuxtLink class="nav-link active" to="/friends"
                  ><i class="bi bi-people"></i> Friends</NuxtLink
                >
              </li>
              <li class="nav-item">
                <NuxtLink class="nav-link active" to="/message"
                  ><i class="bi bi-chat-dots"></i> Message</NuxtLink
                >
              </li>
              <li class="nav-item">
                <NuxtLink class="nav-link active" to="/about"
                  ><svg
                  ...
                  >
                    <path
                      fill="currentColor"
                      d="M20.75 15.75a1.11 1.11 0 0 0 1.107-1.107v-1.11c0-.605-.497-1.107-1.107-1.107s-1.109.502-1.109 1.107v1.11c0 .609.499 1.107 1.109 1.107m-2.214 4.431h1.105v6.278c0 .609.499 1.107 1.109 1.107a1.11 1.11 0 0 0 1.107-1.107v-7.386a1.11 1.11 0 0 0-1.107-1.107h-2.214c-.611 0-1.109.499-1.109 1.107c0 .61.498 1.108 1.109 1.108m0 0"
                    />
                    <path
                      fill="currentColor"
                      d="M20 33.75c-7.582 0-13.75-6.168-13.75-13.749C6.25 12.419 12.418 6.25 20 6.25s13.75 6.169 13.75 13.751c0 7.581-6.168 13.749-13.75 13.749m0-26.5c-7.03 0-12.75 5.72-12.75 12.751c0 7.03 5.72 12.749 12.75 12.749s12.75-5.719 12.75-12.749C32.75 12.97 27.03 7.25 20 7.25"
                    />
                  </svg>
                  About Us</NuxtLink
                >
              ...
              <li class="nav-item">
                <NuxtLink class="nav-link active" to="/groups">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="30"
                    height="30"
                    viewBox="0 0 512 512"
                  >
                    <path d="M256 112z" fill="currentColor"></path>
                    <path
              ...
              <li class="nav-item">
                <NuxtLink class="nav-link active" to="/test"
                  ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="1em"
                    height="1em"
                  ...
                  >
                    <path
                      fill="currentColor"
                      d="M12 3a9 9 0 1 0 0 18a9 9 0 0 0 0-18M1 12C1 5.925 5.925 1 12 1s11 4.925 11 11s-4.925 11-11 11S1 18.075 1 12m5.769-3.866l3.464 2l-1 1.732l-3.464-2zm11.464 1.732l-3.464 2l-1-1.732l3.464-2zM7 13h10v1a5 5 0 0 1-10 0zm2.17 2a3.001 3.001 0 0 0 5.66 0z"
                    ></path>
                  </svg>
                  Test</NuxtLink
                >
